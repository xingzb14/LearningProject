...
Qt_Translation::BaiduTranslation::BaiduTranslation(const QString &apiKey):
    m_apiKey(apiKey)
{ }

std::pair<bool, QString> Qt_Translation::BaiduTranslation::translation(const QString &string, const QString &from, const QString &to)
{
